...
class A_Updater {
public:
    static inline auto update(double m, double l_f, double l_r, double I, double K_f, double K_r, double r, double beta, double accel, double delta, double py, double V, double theta, double px) -> A_Updater_Output_Type {
    ...
    static inline auto sympy_function(double m, double K_f, double V, double beta, double I, double theta, double l_f, double delta, double K_r, double r, double l_r) -> A_Updater_Output_Type {
        ...
        double x2 = 0.01 * cos(theta);

        double x3 = V * x2;

        double x4 = K_f * (l_f * l_f);

        double x5 = K_r * (l_r * l_r);
        ...
        double x13 = K_r * V * l_r - x12;

        double x14 = K_r * beta * l_r - beta * x11 + delta * x11;

        double x15 = V * V;

        double x16 = 1 / x15;

        double x17 = x16 * (K_f * V * delta * l_f + K_r * V * beta * l_r - beta * x12 - r * x4 -
            r * x5);
        ...
        double x26 = 0.0002 * x8;

        double x27 = x26 * x7;

        result.template set<0, 0>(static_cast<double>(1));
        result.template set<0, 1>(static_cast<double>(0));
        result.template set<0, 2>(static_cast<double>(x1));
        result.template set<0, 3>(static_cast<double>(0));
        result.template set<0, 4>(static_cast<double>(0));
        result.template set<0, 5>(static_cast<double>(x2));
        result.template set<0, 6>(static_cast<double>(0.0));
        result.template set<0, 7>(static_cast<double>(0.0));
        result.template set<0, 8>(static_cast<double>(0.0));
        result.template set<0, 9>(static_cast<double>(0.0));
        result.template set<0, 10>(static_cast<double>(0.0));
        result.template set<1, 0>(static_cast<double>(0));
        result.template set<1, 1>(static_cast<double>(1));
        result.template set<1, 2>(static_cast<double>(x3));
        result.template set<1, 3>(static_cast<double>(0));
        result.template set<1, 4>(static_cast<double>(0));
        result.template set<1, 5>(static_cast<double>(x0));
        result.template set<1, 6>(static_cast<double>(0.0));
        result.template set<1, 7>(static_cast<double>(0.0));
        result.template set<1, 8>(static_cast<double>(0.0));
        result.template set<1, 9>(static_cast<double>(0.0));
        result.template set<1, 10>(static_cast<double>(0.0));
        result.template set<2, 0>(static_cast<double>(0));
        result.template set<2, 1>(static_cast<double>(0));
        result.template set<2, 2>(static_cast<double>(1));
        result.template set<2, 3>(static_cast<double>(0.01));
        result.template set<2, 4>(static_cast<double>(0));
        result.template set<2, 5>(static_cast<double>(0));
        result.template set<2, 6>(static_cast<double>(0.0));
        result.template set<2, 7>(static_cast<double>(0.0));
        result.template set<2, 8>(static_cast<double>(0.0));
        result.template set<2, 9>(static_cast<double>(0.0));
        result.template set<2, 10>(static_cast<double>(0.0));
        result.template set<3, 0>(static_cast<double>(0));
        result.template set<3, 1>(static_cast<double>(0));
        result.template set<3, 2>(static_cast<double>(0));
        result.template set<3, 3>(static_cast<double>(x10 * x6 + 1));
        result.template set<3, 4>(static_cast<double>(x10 * x13));
        result.template set<3, 5>(static_cast<double>(x10 * x14 - x17 * x9));
        result.template set<3, 6>(static_cast<double>(0.0));
        result.template set<3, 7>(static_cast<double>(0.0));
        result.template set<3, 8>(static_cast<double>(0.0));
        result.template set<3, 9>(static_cast<double>(0.0));
        result.template set<3, 10>(static_cast<double>(0.0));
        result.template set<4, 0>(static_cast<double>(0));
        result.template set<4, 1>(static_cast<double>(0));
        result.template set<4, 2>(static_cast<double>(0));
        result.template set<4, 3>(static_cast<double>(x21 * (2 * K_r * l_r - x18 - x19)));
        result.template set<4, 4>(static_cast<double>(x21 * (-x23 - x24) + 1));
        result.template set<4, 5>(static_cast<double>(x21 * (2 * K_f * delta - K_f * x25 - K_r * x25 - m * r * x22) - 0.02 * x20 * (2 * K_f * V * delta + 2 * K_r * l_r * r - beta * x23 - beta * x24 - r * x18 - r * x19) / (V * V * V)));
        result.template set<4, 6>(static_cast<double>(0.0));
        result.template set<4, 7>(static_cast<double>(0.0));
        result.template set<4, 8>(static_cast<double>(0.0));
        result.template set<4, 9>(static_cast<double>(0.0));
        result.template set<4, 10>(static_cast<double>(0.0));
        result.template set<5, 0>(static_cast<double>(0));
        result.template set<5, 1>(static_cast<double>(0));
        result.template set<5, 2>(static_cast<double>(0));
        result.template set<5, 3>(static_cast<double>(0));
        result.template set<5, 4>(static_cast<double>(0));
        result.template set<5, 5>(static_cast<double>(1));
        result.template set<5, 6>(static_cast<double>(0.0));
        result.template set<5, 7>(static_cast<double>(0.0));
        result.template set<5, 8>(static_cast<double>(0.0));
        result.template set<5, 9>(static_cast<double>(0.0));
        result.template set<5, 10>(static_cast<double>(0.0));
        result.template set<6, 0>(static_cast<double>(1.0));
        result.template set<6, 1>(static_cast<double>(0));
        result.template set<6, 2>(static_cast<double>(x1));
        result.template set<6, 3>(static_cast<double>(0));
        result.template set<6, 4>(static_cast<double>(0));
        result.template set<6, 5>(static_cast<double>(x2));
        result.template set<6, 6>(static_cast<double>(1));
        result.template set<6, 7>(static_cast<double>(0));
        result.template set<6, 8>(static_cast<double>(0));
        result.template set<6, 9>(static_cast<double>(0));
        result.template set<6, 10>(static_cast<double>(0));
        result.template set<7, 0>(static_cast<double>(0));
        result.template set<7, 1>(static_cast<double>(1.0));
        result.template set<7, 2>(static_cast<double>(x3));
        result.template set<7, 3>(static_cast<double>(0));
        result.template set<7, 4>(static_cast<double>(0));
        result.template set<7, 5>(static_cast<double>(x0));
        result.template set<7, 6>(static_cast<double>(0));
        result.template set<7, 7>(static_cast<double>(1));
        result.template set<7, 8>(static_cast<double>(0));
        result.template set<7, 9>(static_cast<double>(0));
        result.template set<7, 10>(static_cast<double>(0));
        result.template set<8, 0>(static_cast<double>(0));
        result.template set<8, 1>(static_cast<double>(0));
        result.template set<8, 2>(static_cast<double>(0.05));
        result.template set<8, 3>(static_cast<double>(0.0005));
        result.template set<8, 4>(static_cast<double>(0));
        result.template set<8, 5>(static_cast<double>(0));
        result.template set<8, 6>(static_cast<double>(0));
        result.template set<8, 7>(static_cast<double>(0));
        result.template set<8, 8>(static_cast<double>(1));
        result.template set<8, 9>(static_cast<double>(0));
        result.template set<8, 10>(static_cast<double>(0));
        ...
        result.template set<9, 3>(static_cast<double>(x27 * x6 + 0.01));
        result.template set<9, 4>(static_cast<double>(x13 * x27));
        result.template set<9, 5>(static_cast<double>(x14 * x27 - x17 * x26));
        result.template set<9, 6>(static_cast<double>(0));
        result.template set<9, 7>(static_cast<double>(0));
        result.template set<9, 8>(static_cast<double>(0));
        result.template set<9, 9>(static_cast<double>(1));
        result.template set<9, 10>(static_cast<double>(0));
        ...
        result.template set<10, 4>(static_cast<double>(0));
        result.template set<10, 5>(static_cast<double>(1.0));
        result.template set<10, 6>(static_cast<double>(0));
        result.template set<10, 7>(static_cast<double>(0));
        result.template set<10, 8>(static_cast<double>(0));
        result.template set<10, 9>(static_cast<double>(0));
        result.template set<10, 10>(static_cast<double>(1));
...
class B_Updater {
public:
    static inline auto update(double m, double l_f, double l_r, double I, double K_f, double K_r, double r, double beta, double accel, double delta, double py, double V, double theta, double px) -> B_Updater_Output_Type {
    ...
    static inline auto sympy_function(double m, double K_f, double I, double l_f, double V) -> B_Updater_Output_Type {
        ...
        result.template set<2, 0>(static_cast<double>(0));
        result.template set<2, 1>(static_cast<double>(0));
        result.template set<3, 0>(static_cast<double>(x0 * x1));
        result.template set<3, 1>(static_cast<double>(0));
        result.template set<4, 0>(static_cast<double>(x0 / (V * m)));
        result.template set<4, 1>(static_cast<double>(0));
        result.template set<5, 0>(static_cast<double>(0));
        result.template set<5, 1>(static_cast<double>(0.01));
        ...
        result.template set<8, 0>(static_cast<double>(0));
        result.template set<8, 1>(static_cast<double>(0));
        result.template set<9, 0>(static_cast<double>(0.0002 * K_f * x1));
        result.template set<9, 1>(static_cast<double>(0));
        result.template set<10, 0>(static_cast<double>(0));
        result.template set<10, 1>(static_cast<double>(0.01));
...
class C_Updater {
public:
    static inline auto update(double m, double l_f, double l_r, double I, double K_f, double K_r, double r, double beta, double accel, double delta, double py, double V, double theta, double px) -> C_Updater_Output_Type {
        static_cast<void>(m);
    ...
    static inline auto sympy_function() -> C_Updater_Output_Type {
        ...
        result.template set<0, 0>(static_cast<double>(0.0));
        ...
        result.template set<0, 6>(static_cast<double>(1));
        result.template set<0, 7>(static_cast<double>(0));
        result.template set<0, 8>(static_cast<double>(0));
        result.template set<0, 9>(static_cast<double>(0));
        result.template set<0, 10>(static_cast<double>(0));
        result.template set<1, 0>(static_cast<double>(0.0));
        result.template set<1, 1>(static_cast<double>(0.0));
        result.template set<1, 2>(static_cast<double>(0.0));
        ...
        result.template set<1, 6>(static_cast<double>(0));
        result.template set<1, 7>(static_cast<double>(1));
        result.template set<1, 8>(static_cast<double>(0));
        result.template set<1, 9>(static_cast<double>(0));
        result.template set<1, 10>(static_cast<double>(0));
        result.template set<2, 0>(static_cast<double>(0.0));
        result.template set<2, 1>(static_cast<double>(0.0));
        result.template set<2, 2>(static_cast<double>(0.0));
        result.template set<2, 3>(static_cast<double>(0.0));
        result.template set<2, 4>(static_cast<double>(0.0));
        result.template set<2, 5>(static_cast<double>(0.0));
        result.template set<2, 6>(static_cast<double>(0));
        result.template set<2, 7>(static_cast<double>(0));
        result.template set<2, 8>(static_cast<double>(1));
        result.template set<2, 9>(static_cast<double>(0));
        result.template set<2, 10>(static_cast<double>(0));
        result.template set<3, 0>(static_cast<double>(0.0));
        result.template set<3, 1>(static_cast<double>(0.0));
        result.template set<3, 2>(static_cast<double>(0.0));
        result.template set<3, 3>(static_cast<double>(0.0));
        result.template set<3, 4>(static_cast<double>(0.0));
        result.template set<3, 5>(static_cast<double>(0.0));
        result.template set<3, 6>(static_cast<double>(0));
        result.template set<3, 7>(static_cast<double>(0));
        result.template set<3, 8>(static_cast<double>(0));
        result.template set<3, 9>(static_cast<double>(1));
        result.template set<3, 10>(static_cast<double>(0));
        result.template set<4, 0>(static_cast<double>(0.0));
        result.template set<4, 1>(static_cast<double>(0.0));
        result.template set<4, 2>(static_cast<double>(0.0));
        result.template set<4, 3>(static_cast<double>(0.0));
        result.template set<4, 4>(static_cast<double>(0.0));
        result.template set<4, 5>(static_cast<double>(0.0));
        result.template set<4, 6>(static_cast<double>(0));
        result.template set<4, 7>(static_cast<double>(0));
        result.template set<4, 8>(static_cast<double>(0));
        result.template set<4, 9>(static_cast<double>(0));
        result.template set<4, 10>(static_cast<double>(1));
...
public:
    ...
    static inline void update(const X_Type& X, const U_Type& U, const Parameter_Type& parameter, EmbeddedIntegrator_Updater_Output_Type& output) {
        ...
        double l_f = parameter.l_f;
        double l_r = parameter.l_r;
        double I = parameter.I;
        double K_f = parameter.K_f;
        double K_r = parameter.K_r;
        double px = X.template get<0, 0>();
        double py = X.template get<1, 0>();
        double theta = X.template get<2, 0>();
        double r = X.template get<3, 0>();
        ...
        auto A = A_Updater<typename EmbeddedIntegrator_Updater_Output_Type::A_Type>::update(m, l_f, l_r, I, K_f, K_r, r, beta, accel, delta, py, V, theta, px);

        auto B = B_Updater<typename EmbeddedIntegrator_Updater_Output_Type::B_Type>::update(m, l_f, l_r, I, K_f, K_r, r, beta, accel, delta, py, V, theta, px);

        auto C = C_Updater<typename EmbeddedIntegrator_Updater_Output_Type::C_Type>::update(m, l_f, l_r, I, K_f, K_r, r, beta, accel, delta, py, V, theta, px);
