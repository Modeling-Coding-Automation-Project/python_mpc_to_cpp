#include "adaptive_mpc_two_wheel_vehicle_constraints_delay_SIL_wrapper.hpp"

#include "two_wheel_vehicle_model_constraints_delay_SIL_ada_mpc_ekf_parameter.hpp"
...
constexpr std::size_t INPUT_SIZE =
    adaptive_mpc_two_wheel_vehicle_constraints_delay_SIL_wrapper::INPUT_SIZE;
constexpr std::size_t STATE_SIZE =
    adaptive_mpc_two_wheel_vehicle_constraints_delay_SIL_wrapper::STATE_SIZE;
...
void initialize(void) {
  ada_mpc =
      adaptive_mpc_two_wheel_vehicle_constraints_delay_SIL_wrapper::make();
}

void update_parameters(FLOAT m) {

  two_wheel_vehicle_model_constraints_delay_SIL_ada_mpc_ekf_parameter::
...
PYBIND11_MODULE(AdaptiveMpcTwoWheelVehicleConstraintsDelaySIL, m) {
  py::class_<
      two_wheel_vehicle_model_constraints_delay_SIL_ada_mpc_ekf_parameter::
  ...
  m.def(
      "update_parameters",
      [](const two_wheel_vehicle_model_constraints_delay_SIL_ada_mpc_ekf_parameter::
