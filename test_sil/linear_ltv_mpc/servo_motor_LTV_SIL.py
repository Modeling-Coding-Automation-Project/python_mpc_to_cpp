...
def main():
    ...
    from test_sil.linear_mpc import LinearMpcLtvSIL
    LinearMpcLtvSIL.initialize()
    ...
    for i in range(len(time)):
        ...
        if not MPC_updated and time[i] > MPC_UPDATE_TIME:
            ...
            LinearMpcLtvSIL.update_parameters(controller_parameters)

            MPC_updated = True

        U = ltv_mpc.update_manipulation(ref, y_measured)

        U_cpp = LinearMpcLtvSIL.update_manipulation(ref, y_measured)
