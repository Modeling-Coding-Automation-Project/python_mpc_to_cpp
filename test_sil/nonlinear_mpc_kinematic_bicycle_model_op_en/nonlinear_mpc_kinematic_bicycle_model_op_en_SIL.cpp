#include "nonlinear_mpc_kinematic_bicycle_model_op_en_SIL_wrapper.hpp"
...
using FLOAT = typename nonlinear_mpc_kinematic_bicycle_model_op_en_SIL_wrapper::
    EKF_Type::Value_Type;

constexpr std::size_t INPUT_SIZE =
    nonlinear_mpc_kinematic_bicycle_model_op_en_SIL_wrapper::INPUT_SIZE;
constexpr std::size_t STATE_SIZE =
    nonlinear_mpc_kinematic_bicycle_model_op_en_SIL_wrapper::STATE_SIZE;
constexpr std::size_t OUTPUT_SIZE =
    nonlinear_mpc_kinematic_bicycle_model_op_en_SIL_wrapper::OUTPUT_SIZE;

constexpr std::size_t NP =
    nonlinear_mpc_kinematic_bicycle_model_op_en_SIL_wrapper::NP;

using ReferenceTrajectory_Type =
    typename nonlinear_mpc_kinematic_bicycle_model_op_en_SIL_wrapper::
        ReferenceTrajectory_Type;

static std::unique_ptr<
    nonlinear_mpc_kinematic_bicycle_model_op_en_SIL_wrapper::type>
    nonlinear_mpc;

void initialize(void) {

  nonlinear_mpc.reset(
      new nonlinear_mpc_kinematic_bicycle_model_op_en_SIL_wrapper::type(
          nonlinear_mpc_kinematic_bicycle_model_op_en_SIL_wrapper::make()));
...
PYBIND11_MODULE(NonlinearMpcKinematicBicycleModelOpEnSIL, m) {
