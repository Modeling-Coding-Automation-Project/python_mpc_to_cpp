#include "adaptive_mpc_two_wheel_vehicle_constraints_SIL_wrapper.hpp"

#include "two_wheel_vehicle_model_constraints_SIL_ada_mpc_ekf_parameter.hpp"
...
using FLOAT = typename adaptive_mpc_two_wheel_vehicle_constraints_SIL_wrapper::
    type::Value_Type;

constexpr std::size_t INPUT_SIZE =
    adaptive_mpc_two_wheel_vehicle_constraints_SIL_wrapper::INPUT_SIZE;
constexpr std::size_t STATE_SIZE =
    adaptive_mpc_two_wheel_vehicle_constraints_SIL_wrapper::STATE_SIZE;
constexpr std::size_t OUTPUT_SIZE =
    adaptive_mpc_two_wheel_vehicle_constraints_SIL_wrapper::OUTPUT_SIZE;

using Ref_Type =
    typename adaptive_mpc_two_wheel_vehicle_constraints_SIL_wrapper::Ref_Type;

adaptive_mpc_two_wheel_vehicle_constraints_SIL_wrapper::type ada_mpc;

void initialize(void) {
  ada_mpc = adaptive_mpc_two_wheel_vehicle_constraints_SIL_wrapper::make();
}

void update_parameters(FLOAT m) {

  two_wheel_vehicle_model_constraints_SIL_ada_mpc_ekf_parameter::Parameter_Type
...
PYBIND11_MODULE(AdaptiveMpcTwoWheelVehicleConstraintsSIL, m) {
  py::class_<
      two_wheel_vehicle_model_constraints_SIL_ada_mpc_ekf_parameter::Parameter>(
      m, "Parameter")
      .def(py::init<>())
      .def_readwrite(
          "m", &two_wheel_vehicle_model_constraints_SIL_ada_mpc_ekf_parameter::
                   Parameter::m)
      .def_readwrite(
          "l_f",
          &two_wheel_vehicle_model_constraints_SIL_ada_mpc_ekf_parameter::
              Parameter::l_f)
      .def_readwrite(
          "l_r",
          &two_wheel_vehicle_model_constraints_SIL_ada_mpc_ekf_parameter::
              Parameter::l_r)
      .def_readwrite(
          "I", &two_wheel_vehicle_model_constraints_SIL_ada_mpc_ekf_parameter::
                   Parameter::I)
      .def_readwrite(
          "K_f",
          &two_wheel_vehicle_model_constraints_SIL_ada_mpc_ekf_parameter::
  ...
  m.def(
      "update_parameters",
      [](const two_wheel_vehicle_model_constraints_SIL_ada_mpc_ekf_parameter::
             Parameter &param) { ada_mpc.update_parameters(param); },
